...
module fnd_controller #(
    ...
    input                   display_mode_ms,
    input                   display_mode_ts,
    input                   display_mode_ta,
    input [3:0]             cho_reg,
    output [           3:0] fnd_com,
    output [           7:0] fnd_data,
    output [          15:0] led
    ...
    wire [3:0] w_msec_sec, w_min_hour,w_beside_mode_mh, w_beside_mode_ms, msec_sec, min_hour;
    wire [2:0] w_digit_sel;
    wire [3:0] bcd;
    wire w_dot_onoff, w_dot_beside;
    wire w_1khz;
    ...
    assign led[15:4] = w_led_fnd;
    assign msec_sec = display_mode_ta ? w_beside_mode_ms : w_msec_sec;
    assign min_hour = display_mode_ta ? w_beside_mode_mh : w_min_hour;
    assign led[10] = w_cho_msec;
    assign led[11] = w_cho_min;
    assign led[13] = w_cho_sec;
    assign led[14] = w_cho_hour;
    ...
    // beside_dot U_BESIDE_DOT(
    //     .sel_time(sel_time),
    //     .w_dot_beside(w_dot_beside)
    // );
    ...
    mux_8x1 U_MUX_8X1_BESIDE_SEC_MSEC (
        .sel(w_digit_sel),
        .in0(w_msec_digit_1),
        .in1(w_msec_digit_10),
        .in2(w_sec_digit_1),
        .in3(w_sec_digit_10),
        .in4({3'b111, w_cho_msec}),
        .in5({3'b111, w_cho_msec}),
        .in6({3'b111, w_cho_sec}),
        .in7({3'b111, w_cho_sec}),
        .mux_out(w_beside_mode_ms)
    );
    ...
    mux_8x1 U_MUX_8X1_BESIDE_MIN_HOUR (
        .sel(w_digit_sel),
        .in0(w_min_digit_1),
        .in1(w_min_digit_10),
        .in2(w_hour_digit_1),
        .in3(w_hour_digit_10),
        .in4({3'b111, w_cho_min}),
        .in5({3'b111, w_cho_min}),
        .in6({3'b111, w_cho_hour}),
        .in7({3'b111, w_cho_hour}),
        .mux_out(w_beside_mode_mh)
    );
...
//     assign w_dot_beside = (sel_time) ? 1'b1 : 1'b0;
...
module bcd( // decoder : 적은 bit > 많은 bit(2의 n승 bit수를 n bit수로 바꿈)  
    ...
    always @(bcd_in) begin  // 항상 감시해라 @(대상의 변화 : event)
        case(bcd_in)    // case는 full case 처리 (모든 경우를 기술해라) //full case가 아니면 latch가 발생할수 있다.
            ...
            4'b1111: bcd_out = 8'hff;  //dit display off
