...
HD_PWD='D:/work/26_AI_COMP_1/2026_07_23_moore_fsm/2026_07_23_moore_fsm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_moore_led01.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsm_moore_led01.tcl
