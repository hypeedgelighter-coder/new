...
module ascii_decoder (
    ...
    localparam ASCII_r = 8'h72;  // run
    localparam ASCII_s = 8'h73;  // stop
    localparam ASCII_c = 8'h63;  // clear
    localparam ASCII_m = 8'h6D;  // mode
    localparam ASCII_U = 8'h55;  // 증가
    localparam ASCII_D = 8'h44;  // 감소
    localparam ASCII_L = 8'h4C;  // 왼쪽
    localparam ASCII_R = 8'h52;  // 오른쪽
    localparam ASCII_S = 8'h53;  // 초 증가
    localparam ASCII_M = 8'h4D;  // 분 증가
    localparam ASCII_H = 8'h48;  // 시 증가
