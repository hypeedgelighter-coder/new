...
HD_PWD='D:/work/26_AI_COMP_1/2026_07_23_moore_fsm/2026_07_23_moore_fsm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_moore_led01.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fsm_moore_led01.tcl -notrace
